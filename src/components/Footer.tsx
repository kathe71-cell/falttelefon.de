...
import { Shield, ExternalLink, ShoppingBag, CheckCircle2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed max-w-lg">
              Der große deutsche Kaufberater &amp; Preisvergleich für Falt-Smartphones (Foldables &amp; Clamshells).
              Wir vergleichen aktuelle Modelle, Zubehör und Angebote – mit ehrlichen Kaufempfehlungen und direktem Preis-Check bei Amazon.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                ...
                >
                  → Falt-Handy Angebote bei Amazon * <ExternalLink className="w-3 h-3" />
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 p-3 rounded-lg bg-slate-900/80 border border-slate-800 text-[11px] text-slate-400 leading-snug">
              ...
              * Mit Sternchen gekennzeichnete Verweise sind Affiliate-Links (Amazon PartnerNet).
              Beim Kauf über diese Links erhält falttelefon.de eine kleine Provision. Für Sie entstehen keinerlei Mehrkosten.
            </div>
          </div>
        </div>

        {/* Bottom Bar: Clean & Protected */}
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>
            © 2026 falttelefon.de · Unabhängiger Kaufberater für Falt-Smartphones. Alle Produktbezeichnungen und Marken gehören den jeweiligen Herstellern.
          </p>
